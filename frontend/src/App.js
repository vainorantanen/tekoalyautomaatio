...
import ProjectManagementTable from './components/Profile/ActiveProjects/ProjectManagementTable'
    ...
    <ThemeProvider theme={theme}>
      <Box>
        ...
        <Routes>
          ...
          <Route path='/profiili/projektit/:id' element={<ProjectManagementTable />} />
